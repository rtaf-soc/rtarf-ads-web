  ...
  <q-page v-if="auth.isAuthenticated">
    ...
    <q-dialog v-model="edit_ingredient_detail_isOpen">
      <q-card style="width: 800px; max-width: 800vw;">
        ...
        <q-item class="q-pl-lg q-pr-lg" style="min-height: 200px;">
          <q-item-section>
            <q-input class="q-pb-lg" v-model="edit_ingredient_detail.blacklistCode" outlined label="Domain IP" />
    ...
    <q-dialog v-model="add_ingredient_detail_isOpen">
      <q-card style="width: 800px; max-width: 800vw;">
        ...
        <q-item class="q-pl-lg q-pr-lg" style="min-height: 200px;">
          <q-item-section>
            <q-input class="q-pb-lg" v-model="add_ingredient_detail.blacklistCode" outlined label="Domain IP" />
...
const table_columns_menu = [
  ...
  { name: 'blacklistCode', align: 'left', label: 'Domain IP', field: 'blacklistCode', sortable: true, },
