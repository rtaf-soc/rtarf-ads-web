                ...
                <q-card-section class="row items-center q-pb-none">
                    <div class="text-h6">
                        ...
                        <q-badge
                            ...
                            align="middle"
                            color="positive"
                            >{{ edit_ingredient_detail.ipMapId }}
                        </q-badge>
                    </div>
            ...
            edit_ingredient_detail.blacklistCode }} </q-badge></div> -->
                ...
                <q-item class="q-pl-lg q-pr-lg" style="min-height: 200px">
                    <q-item-section>
                        <q-input
                            class="q-pb-lg"
                            v-model="edit_ingredient_detail.cidr"
                            outlined
                            label="CIDR"
                        />
                        <q-input
                            class="q-pb-lg"
                            v-model="edit_ingredient_detail.zone"
                            outlined
                            label="Network Zone"
                        />
            ...
            <q-card style="width: 800px; max-width: 800vw">
                ...
                <q-item class="q-pl-lg q-pr-lg" style="min-height: 200px">
                    <q-item-section>
                        <q-input
                            class="q-pb-lg"
                            v-model="add_ingredient_detail.cidr"
                            outlined
                            label="CIDR"
                        >
                        ...
                        <q-input
                            class="q-pb-lg"
                            v-model="add_ingredient_detail.zone"
                            outlined
                            label="Network Zone"
                        />
...
export default {
    ...
    data() {
        return {
            ...
            newMenuName: "",
            newIngredients: [{ name: "", weight: "", tolerance: "" }],
            loading,
            visible_menu_columns: ref([
                "index",
                "name",
                "price",
                "description",
    ...
    methods: {
        ...
        async onClick(fn_name, param = null) {
            switch (fn_name) {
                ...
                case "saveEditIngredient":
                    ...
                    break;
                case "saveAddTable":
                    this.add_ingredient_detail.createdDate =
                ...
                case "editRule":
                    if (!this.showEditor) {
                        this.edit_ingredient_detail.ruleDefinition =
                            await this.getRulesById(
                                this.edit_ingredient_detail.ruleId,
                            );
                    }
        ...
        async deleteSelectedRows() {
            ...
            let html = data
                .map(
                    (item) =>
                        `${item.index}. CIDR : ${item.cidr} , TAGS : ${item.tags}`,
                )
                .join("<br/>");
